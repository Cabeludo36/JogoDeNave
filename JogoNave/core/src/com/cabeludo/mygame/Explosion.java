...
class Explosion {
    ...
    public void update(float deltaTempo){
        explosaoTimer += deltaTempo;
    }

    public void draw(SpriteBatch batch) {
        batch.draw(explosionAnimation.getKeyFrame(explosaoTimer), boundingBox.x,boundingBox.y,boundingBox.width,boundingBox.height);
    }

    public boolean isFinishid() {
        return explosionAnimation.isAnimationFinished(explosaoTimer);
    }
}
